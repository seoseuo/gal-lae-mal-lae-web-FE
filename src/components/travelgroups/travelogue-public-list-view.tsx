            ...
            {traveloguePublicList.map((travelogue) => (
                <div key={travelogue.tlIdx}>
                    <div className="travelogue-public-view-profile">
                        <img className="travelogue-public-view-profile-img" src={`/s3/${travelogue.usProfile}`} alt={travelogue.usName} style={{objectFit:'cover'}} />
                        <span className="travelogue-public-view-profile-text-name">{travelogue.usName}</span>
                    </div>

                    <img className="travelogue-public-view-content-img" src={`/s3/${travelogue.tlImage}`} alt={travelogue.tlImage} style={{objectFit:'cover'}}/>
