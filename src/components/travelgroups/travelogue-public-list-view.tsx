            ...
            {traveloguePublicList.map((travelogue) => (
                <div key={travelogue.tlIdx}>
                    <div className="travelogue-public-view-profile">
                        <img className="travelogue-public-view-profile-img" src={travelogue.usProfile} alt={travelogue.usName} />
                        <span className="travelogue-public-view-profile-text-name">{travelogue.usName}</span>
                    </div>

                    <img className="travelogue-public-view-content-img" src={travelogue.tlImage} alt={travelogue.tlImage} />
