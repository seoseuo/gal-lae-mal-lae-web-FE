...
export default function TourSpotsListView({ tourSpotList = [], scDate }: { tourSpotList: any[], scDate: number }) {    
    ...
    return (
        <div className="tour-spots-container">
                ...
                <div key={index} className="tour-spots-view">
                    ...
                    <label htmlFor={`checkbox-${index}`}>
                        <div className="tour-spots-card">
                            <img
                                src={tourSpot.tsFirstImage ? tourSpot.tsFirstImage : "/travelgroups/tour-spot.png"}
                                alt="img"
                            ...
                            <div className="tour-spots-detail">
                                ...
                                <div className="tour-spots-detail-box">
                                    ...
                                    <span className="regular tour-span-text" style={{ fontSize: '5px' }}>
                                        {tourSpot.tsTel ? tourSpot.tsTel : "전화번호가 없습니다."}
                                    </span>
                                    <img
            ...
            <button
                className={`${
                    selectedSpots.size > 0 ? 'long-active-button' : 'long-nomal-button'
                } bottom-button-postion travelgroups-font-size`}
