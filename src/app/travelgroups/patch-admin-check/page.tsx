    ...
    return (
        <div>
            ...
            <div className="travelgroup-container">
                <img src={`/s3/${user.usProfile}`} alt="profile" style={{ width: '120px', height: '120px' , borderRadius: '50%'}} />
                ...
                <button className="long-nomal-button bottom-button-postion travelgroups-font-size" style={{ top: '650px' }} onClick={() => router.back()}>다른 프로필 선택</button>
